...
if (IsObjectiveDisplayed(10) == 1 )		;added by The Choice is Yours
...
(WSN_Peryite_Quest as wsn_peryite_script).Tempt(25, WSN_Temptation_Global_Hircine)
;END CODE
EndFunction
;END FRAGMENT
...
Function Fragment_0()
;BEGIN CODE
;SetObjectiveDisplayed(10, 1)			;added by The Choice is Yours
...
globalvariable property WSN_Temptation_Global_Hircine auto
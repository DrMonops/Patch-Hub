...
;stage added by The Choice is Yours
setObjectiveCompleted(101)
;setObjectiveDisplayed(300)  ;Removed in TCIY Version 1.3
...
stop()    ;Added in TCIY Version 1.3
;END CODE
EndFunction
;END FRAGMENT
...
;WINTERSUN
(WSN_Peryite_Quest as wsn_peryite_script).Tempt(14, WSN_Temptation_Global_Boethiah)
...
Spell Property DA02Curse Auto 
Quest Property KRY_DA02Dremora Auto
ObjectReference Property MolagBalShrineMarker Auto

Quest property WSN_Peryite_Quest auto
globalvariable property WSN_Temptation_Global_Boethiah auto
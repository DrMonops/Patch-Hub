...
;BEGIN ALIAS PROPERTY FFRiften20HorikJarlAlias
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_FFRiften20HorikJarlAlias Auto
;END ALIAS PROPERTY
...
if ( IsObjectiveDisplayed(20) == 1 )	; added by The Choice is Yours
...
;SetObjectiveDisplayed(10,1)			; edited by The Choice is Yours
;END CODE
EndFunction
;END FRAGMENT
